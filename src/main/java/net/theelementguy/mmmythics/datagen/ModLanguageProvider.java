...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModItems.CELESTIAL_BRONZE_UPGRADE_SMITHING_TEMPLATE.get(), "Smithing Template");
        add(ModItems.IMPERIAL_GOLD_UPGRADE_SMITHING_TEMPLATE.get(), "Smithing Template");
        addSmithingTemplateTranslations(ModItems.CELESTIAL_BRONZE_UPGRADE_SMITHING_TEMPLATE.get(), "Bronze Sword", "Nether Star", "Add a Bronze Sword", "Add a Nether Star", "Celestial Bronze Upgrade");
        addSmithingTemplateTranslations(ModItems.IMPERIAL_GOLD_UPGRADE_SMITHING_TEMPLATE.get(), "Golden Sword", "Nether Star", "Add a Golden Sword", "Add a Nether Star", "Imperial Gold Upgrade");
    ...
    private void addSmithingTemplateTranslations(Item smithingTemplate, String appliesTo, String ingredients, String baseDescription, String ingredientDescription, String smithingDescription) {
        ...
        add("upgrade.mmmythics." + BuiltInRegistries.ITEM.getKey(smithingTemplate).getPath().replace("_smithing_template", ""), smithingDescription);
    }
